...
\begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{l l c X}
        ...
        \addlinespace
        \textbf{\textbf{Solución Propuesta (TFG)}} & \textbf{SaaS flexible} & \textbf{EXCELENTE} & \textbf{Integra todo lo anterior: RRHH + Operativa + Dashboard CEO. Móvil nativo. Bajo coste. Flexible.} \\
        \bottomrule
    \end{tabularx}
\end{table}
