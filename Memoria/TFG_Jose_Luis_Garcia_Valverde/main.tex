...
% Configuración de penalizaciones para ruptura de líneas
\hyphenpenalty=50
\exhyphenpenalty=50
\linepenalty=10
\interlinepenalty=0
...
\input{capitulos/03_stack_tecnologico}
\input{capitulos/04_secciones}
\input{capitulos/05_division_tareas}
