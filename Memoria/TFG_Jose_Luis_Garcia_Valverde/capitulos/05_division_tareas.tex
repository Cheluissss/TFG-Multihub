...
\begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{imagenes/diagramas/sprint1_er.png}}
\end{center}
...
\begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{imagenes/diagramas/pbi6_login_sequence.png}}
\end{center}
...
El proceso de validación de roles en cada petición muestra el flujo defensivo de autorización:
\begin{itemize}
...
\begin{center}
    \resizebox{\textwidth}{!}{\includegraphics{imagenes/diagramas/pbi8_rbac_sequence.png}}
\end{center}
