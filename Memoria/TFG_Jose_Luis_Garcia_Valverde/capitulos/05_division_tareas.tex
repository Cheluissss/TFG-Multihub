...
\begin{table}[h]
    ...
    \vspace{0.3cm}
    \begin{tabularx}{\textwidth}{p{0.12\textwidth} X c p{0.12\textwidth}}
        \toprule
...
El schema de base de datos define cuatro entidades principales: User (con roles ADMIN/MANAGER/EMPLOYEE), Sede (ubicaciones físicas), Shift (turnos asignados), y ShiftRequest (solicitudes de permuta). 

\href{run:imagenes/diagramas/sprint1_er.png}{\texttt{Ver diagrama ER completo \textendash{} click aquí para abrir}}
...
El flujo de autenticación muestra los controles de seguridad en cada etapa:

\href{run:imagenes/diagramas/pbi6_login_sequence.png}{\texttt{Ver diagrama de secuencia de login}}
...
El proceso de validación de roles en cada petición muestra el flujo defensivo de autorización con validación en múltiples capas (middleware JWT, middleware rol, filtrado DB).

\href{run:imagenes/diagramas/pbi8_rbac_sequence.png}{\texttt{Ver diagrama de secuencia de autorización RBAC \textendash{} click aquí para abrir}}
